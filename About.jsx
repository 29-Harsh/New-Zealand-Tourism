  ...
  render() {
    ...
    return (
      <div className="App" >
        ...
        <section className="page-section other" id="services">
        ...
        <div class="col-lg-12 col-md-3 col-xs-6 thumb">
          <div className="embed-responsive embed-responsive-21by9">
            <iframe width="1200" height="506" className="embed-responsive-item" src="https://www.youtube.com/embed/_eMAXOp2PvA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
        <br />
        <Maincontact />
